...
My personal collection of Agent Skills: skills I use, write, and curate for real software work. Shared publicly so others can install, adapt, and improve them.

## Install

```sh
npx skills@latest add orshemtov/skills
```
...
- [AWS Agent Toolkit](https://github.com/aws/agent-toolkit-for-aws) — Official AWS development skills.
- [FastAPI](https://github.com/fastapi/fastapi) — Official FastAPI development guidance and references.
- [Impeccable](https://github.com/pbakaus/impeccable) — Frontend design, critique, and UI quality workflows.
...
- [Supabase](https://github.com/supabase/agent-skills) — Official Supabase and PostgreSQL skills.
- [Vercel Agent Skills](https://github.com/vercel-labs/agent-skills) — Official React, composition, and web design guidance.
